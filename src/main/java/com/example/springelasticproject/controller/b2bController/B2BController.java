...
public class B2BController {
    ...
    public ResponseEntity<Map<String, Object>> searchByAttributes04NoFus(
        ...
        Map<String, Object> searchResults = B2BService.searchByAttributes04NoFuss(attributes, pageable);
    ...
    public void exportUsersToCsv(@RequestBody Map<String, String> attributes, HttpServletResponse response) throws IOException {
        exportB2BService.ExportSearchDataB2B(attributes ,response); // méthode modifiée pour retourner une liste
    }
