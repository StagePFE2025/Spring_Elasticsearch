...
@Service
public class B2BScoreServiceFast2 {
    ...
    @Autowired
    public B2BScoreServiceFast2(B2BRepository b2bRepository,
    ...
    public void calculateAndStoreScoresBatch() {
        final int BATCH_SIZE = 1000; // Adjust based on memory and performance
